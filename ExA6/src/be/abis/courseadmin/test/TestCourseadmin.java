...
import be.abis.courseadmin.exA6.Address;
import be.abis.courseadmin.exA6.Company;
import be.abis.courseadmin.exA6.Person;
...
public class TestCourseadmin {
	...
	public static void main(String[] args) {	
		...
		Person person1 = new Person(5, "Ann", "Smits", LocalDate.of(1985, 5, 10), company1);
